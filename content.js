(function () {
  ...
  const CONFIG = {
    ...
    welcomeText: `Welcome To MiniFeather Client! <span style="color:#888;font-size:12px;margin-left:8px;">Kings SMP Client</span>`,
    discordReplacements: {
      "Find teammates and squad up for any mode": "Find Kings SMP members and squad up",
      "Be first to hear about updates and new content": "Get Kings SMP updates and news",
      "Giveaways, events and booster-only perks": "KSMP events, giveaways and perks",
      "Chat with the devs and the rest of the community": "Chat with the Kings SMP community",
      "Join the Miniblox community": "Join the Kings SMP community",
    },
    adSelectors: [
      "iframe[src*='ads']",
