(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      remove: 'Remove',
      joinServer: 'Join Kings SMP',
      aboutLine1: 'Open the panel with Right Shift.',
      aboutLine2: 'Settings are saved automatically.',
      welcomeHtml: 'Welcome To MiniFeather Client! <span style="color:#7b8495;font-size:11px;margin-left:6px;">Kings SMP</span>',
      discordDesc1: 'Find Kings SMP members and squad up',
      discordDesc2: 'Get Kings SMP updates and news',
      discordDesc3: 'KSMP events, giveaways and perks',
      discordDesc4: 'Chat with the Kings SMP community',
      discordDesc5: 'Join the Kings SMP community',
      preview: 'Preview',
